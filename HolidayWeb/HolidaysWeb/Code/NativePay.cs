...
namespace WxPayAPI
{
    public class NativePay
    {
        ...
        * @return 模式二URL
        */
        public string GetPayUrl(string orderNo, string productName ,string price)
        {
            ...
            data.SetValue("out_trade_no", orderNo);//订单号
            ...
            string url = result.GetValues()["code_url"].ToString();//获得统一下单接口返回的二维码链接
